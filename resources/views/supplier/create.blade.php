					  ...
					  <div class="card-body">
					    <form class="form-horizontal" method="POST" action="/supplier">
					      ...
					      <div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
					        ...
					        <div class="col-sm-9">
					          <input name="name" id="inputHorizontalSuccess" type="text" placeholder="Nama supplier" class="form-control form-control-success" value="{{ old('name') }}" required>
					          @if ($errors->has('name'))
					      ...
					      <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
					        ...
					        <div class="col-sm-9">
					          <input name="description" id="inputHorizontalSuccess" type="text" placeholder="Keterangan supplier : supplier pupuk/benih/dll" class="form-control form-control-success" value="{{ old('description') }}" required>
